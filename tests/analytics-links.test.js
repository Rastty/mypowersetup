...
test("guide calculator classifier accepts localized calculator anchors", () => {
  ...
  assert.deepEqual(classifyGuideCalculatorLink("/ro/#kalkulator"), { destination_path: "/ro/" });
});

test("guide calculator classifier rejects external, malformed and non-calculator links", () => {
