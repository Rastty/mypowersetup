...
const MARKETS = Object.freeze([
  {
    ...
    expectedPublic: true,
    homepage: "index.html",
    canonicalUrl: "https://mypowersetup.com/",
    catalogs: ["data/products.json", "data/products-ampul-cz.json"],
    guideRoot: "pruvodce",
  },
  {
    key: "sk",
    locale: "sk-SK",
    expectedPublic: true,
    homepage: "sk/index.html",
    canonicalUrl: "https://mypowersetup.com/sk/",
    catalogs: ["data/products-sk.json"],
    guideRoot: "sk/sprievodca",
  },
  {
    key: "pl",
    locale: "pl-PL",
    expectedPublic: true,
    homepage: "pl/index.html",
    canonicalUrl: "https://mypowersetup.com/pl/",
    catalogs: ["data/products-pl.json"],
    guideRoot: "pl/poradnik",
  },
  {
    key: "hu",
    locale: "hu-HU",
