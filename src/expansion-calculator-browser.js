...
const labels = {
  ...
  pt: {
    ...
    recommendationBadges: { recommended: "A nossa recomendação", budget: "Preço mais baixo", reserve: "Maior margem", alternative: "Alternativa compatível" }, purchaseChecks: ["Compatibilidade técnica", "Ligação exata", "Entrega verificada"], viewAt: (merchant) => `Ver preço na ${merchant}`,
  ...
  si: {
    ...
    recommendationBadges: { recommended: "Naše priporočilo", budget: "Najnižja cena", reserve: "Več rezerve", alternative: "Združljiva alternativa" }, purchaseChecks: ["Tehnična ustreznost", "Točna povezava", "Preverjena dostava"], viewAt: (merchant) => `Preveri ceno pri ${merchant}`,
...
function expansionMerchantLabel(merchant) { return ({ allpowers_pt: "ALLPOWERS", allpowers_eu: "ALLPOWERS", powerqueen_eu: "Power Queen", bluetti_eu: "BLUETTI", oxe_ro: "OXE", oxe_si: "OXE" })[merchant] || labels.viewProduct; }
