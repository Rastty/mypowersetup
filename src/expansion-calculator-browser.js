...
const labels = {
  ro: {
    ...
    recommendationBadges: { recommended: "Recomandarea noastră", budget: "Cel mai mic preț", reserve: "Rezervă mai mare", alternative: "Alternativă compatibilă" }, purchaseChecks: ["Potrivire tehnică", "Link exact", "Livrare verificată"], viewAt: (merchant) => `Vezi prețul la ${merchant}`, compareAlternatives: (count) => `Compară alternativele (${count})`,
  ...
  pt: {
    ...
    recommendationBadges: { recommended: "A nossa recomendação", budget: "Preço mais baixo", reserve: "Maior margem", alternative: "Alternativa compatível" }, purchaseChecks: ["Compatibilidade técnica", "Ligação exata", "Entrega verificada"], viewAt: (merchant) => `Ver preço na ${merchant}`, compareAlternatives: (count) => `Comparar alternativas (${count})`,
  ...
  si: {
    ...
    recommendationBadges: { recommended: "Naše priporočilo", budget: "Najnižja cena", reserve: "Več rezerve", alternative: "Združljiva alternativa" }, purchaseChecks: ["Tehnična ustreznost", "Točna povezava", "Preverjena dostava"], viewAt: (merchant) => `Preveri ceno pri ${merchant}`, compareAlternatives: (count) => `Primerjaj alternative (${count})`,
