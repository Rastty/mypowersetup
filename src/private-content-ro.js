...
export function renderRomaniaPrivateContentPage(pathname) {
  ...
  const topCta = page.type === "guide" ? `<p class="cta"><a class="button button-primary" href="/ro/#calculator-preview">Calculează sistemul meu</a></p>` : "";
  const bottomCta = page.type === "guide" ? `<aside class="cta"><h2>Calculează cu propriul consum</h2><p>Folosește aceleași ipoteze tehnice din acest ghid pentru a dimensiona bateria, solarul, invertorul și încărcarea autorulotei.</p><a class="button button-primary" href="/ro/#calculator-preview">Deschide calculatorul</a></aside>` : "";
