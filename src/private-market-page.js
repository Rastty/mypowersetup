...
const CALCULATOR_COPY = Object.freeze({
  ro: Object.freeze({ title: "Trei pași către sistemul tău", intro: "Folosește valori realiste pentru consumatorii pe care îi vei alimenta zilnic.", steps: ["Utilizare", "Consumatori", "Rezultat"], step1: "Câte zile vrei autonomie și în ce sezon călătorești?", days: "Zile fără încărcare", season: "Sezon pentru dimensionarea solarului", seasons: ["Vară", "Primăvară / toamnă", "Iarnă"], next: "Alege consumatorii", step2: "Ce vrei să alimentezi în fiecare zi?", appliances: ["Frigider cu compresor", "Iluminat LED", "Pompă de apă", "Laptop", "Televizor", "Espressor"], battery: "Tip baterie", batteryLead: "AGM / plumb-acid", voltage: "Tensiune sistem", voltageAuto: "Auto", hoursPerDay: "h/day", back: "Înapoi", calculate: "Calculează sistemul", step3: "Estimarea sistemului tău", private: "Previzualizare privată pentru România — rezultatele nu sunt încă publicate sau indexate." }),
  pt: Object.freeze({ title: "Três passos para o teu sistema", intro: "Usa valores realistas para os equipamentos que pretendes alimentar todos os dias.", steps: ["Utilização", "Equipamentos", "Resultado"], step1: "Quantos dias de autonomia queres e em que época viajas?", days: "Dias sem carregamento", season: "Época para dimensionar o solar", seasons: ["Verão", "Primavera / outono", "Inverno"], next: "Escolher equipamentos", step2: "O que queres alimentar todos os dias?", appliances: ["Frigorífico de compressor", "Iluminação LED", "Bomba de água", "Portátil", "Televisão", "Máquina de café"], battery: "Tipo de bateria", batteryLead: "AGM / chumbo-ácido", voltage: "Tensão do sistema", voltageAuto: "Automático", hoursPerDay: "h/dia", back: "Voltar", calculate: "Calcular o sistema", step3: "Estimativa do teu sistema", private: "Pré-visualização privada para Portugal — os resultados ainda não são publicados nem indexados." }),
...
<body>
  ...
  <script type="module" src="/src/expansion-calculator-browser.js?v=20260830-3"></script>
</body>
</html>`;
}
