...
const CALCULATOR_COPY = Object.freeze({
  ro: Object.freeze({ title: "Trei pași către sistemul tău", intro: "Folosește valori realiste pentru consumatorii pe care îi vei alimenta zilnic.", steps: ["Utilizare", "Consumatori", "Rezultat"], step1: "Câte zile vrei autonomie și în ce sezon călătorești?", days: "Zile fără încărcare", season: "Sezon pentru dimensionarea solarului", seasons: ["Vară", "Primăvară / toamnă", "Iarnă"], next: "Alege consumatorii", step2: "Ce vrei să alimentezi în fiecare zi?", appliances: ["Frigider cu compresor", "Iluminat LED", "Pompă de apă", "Laptop", "Televizor", "Espressor"], battery: "Tip baterie", voltage: "Tensiune sistem", back: "Înapoi", calculate: "Calculează sistemul", step3: "Estimarea sistemului tău", private: "Previzualizare privată pentru România — rezultatele nu sunt încă publicate sau indexate." }),
  pt: Object.freeze({ title: "Três passos para o teu sistema", intro: "Usa valores realistas para os equipamentos que pretendes alimentar todos os dias.", steps: ["Utilização", "Equipamentos", "Resultado"], step1: "Quantos dias de autonomia queres e em que época viajas?", days: "Dias sem carregamento", season: "Época para dimensionar o solar", seasons: ["Verão", "Primavera / outono", "Inverno"], next: "Escolher equipamentos", step2: "O que queres alimentar todos os dias?", appliances: ["Frigorífico de compressor", "Iluminação LED", "Bomba de água", "Portátil", "Televisão", "Máquina de café"], battery: "Tipo de bateria", voltage: "Tensão do sistema", back: "Voltar", calculate: "Calcular o sistema", step3: "Estimativa do teu sistema", private: "Pré-visualização privada para Portugal — os resultados ainda não são publicados nem indexados." }),
  si: Object.freeze({ title: "Trije koraki do tvojega sistema", intro: "Uporabi realne vrednosti za porabnike, ki jih želiš napajati vsak dan.", steps: ["Uporaba", "Porabniki", "Rezultat"], step1: "Koliko dni avtonomije želiš in v katerem letnem času potuješ?", days: "Dnevi brez polnjenja", season: "Obdobje za dimenzioniranje solarnega sistema", seasons: ["Poletje", "Pomlad / jesen", "Zima"], next: "Izberi porabnike", step2: "Kaj želiš napajati vsak dan?", appliances: ["Kompresorski hladilnik", "LED razsvetljava", "Vodna črpalka", "Prenosnik", "Televizor", "Kavni aparat"], battery: "Vrsta baterije", voltage: "Napetost sistema", back: "Nazaj", calculate: "Izračunaj sistem", step3: "Ocena tvojega sistema", private: "Zasebni predogled za Slovenijo — rezultati še niso javno objavljeni ali indeksirani." }),
});
