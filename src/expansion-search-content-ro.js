...
<section data-ro-search-growth="incarcator-dc-dc-autorulota">
  ...
  "/ro/ghiduri/incarcator-230v-baterie-autorulota/": Object.freeze({
    title: "Cum alegi încărcătorul de 230 V pentru bateria autorulotei",
    description: "Dimensionează încărcătorul de la rețea după chimie, capacitate, timpul disponibil și limita BMS, cu exemple LiFePO4 și AGM.",
    body: `
<section data-ro-search-growth="incarcator-230v-baterie-autorulota">
  <h2>Răspuns scurt: alege amperajul după timpul de încărcare și limitele bateriei</h2>
  <p>Încărcătorul de 230 V transformă alimentarea campingului într-o încărcare DC controlată. Curentul corect depinde de chimia bateriei, curentul recomandat de producător, limita BMS, timpul petrecut la priză și consumatorii care rămân porniți.</p>
  <p>Ca estimare inițială, <strong>timpul ideal în ore ≈ Ah de completat ÷ amperajul încărcătorului</strong>. Timpul real este mai lung din cauza pierderilor, absorbției și consumului simultan.</p>

  <h2>Exemplu: baterie LiFePO₄ de 200 Ah</h2>
  <p>Pentru a completa 120 Ah, un încărcător de 20 A are nevoie de cel puțin 6 ore ideale, iar unul de 30 A de cel puțin 4 ore. Dacă frigiderul, luminile și electronica folosesc 5 A, dintr-un încărcător de 20 A rămân aproximativ 15 A pentru baterie.</p>
  <p>Nu alege automat 50 A. Bateria și BMS-ul trebuie să accepte curentul, cablurile DC trebuie dimensionate pentru el, iar încărcătorul are nevoie de ventilație pentru a evita reducerea termică.</p>

  <h2>LiFePO₄ și AGM cer profile diferite</h2>
  <p>Alege un profil confirmat pentru chimia instalată. Tensiunea de absorbție, menținerea și încărcarea la temperatură joasă nu se copiază de la altă baterie. Pentru LiFePO₄, BMS-ul sau un senzor compatibil trebuie să blocheze încărcarea sub temperatura permisă de producător.</p>
  <p><a href="https://www.victronenergy.com/upload/documents/Blue_Smart_IP65_Charger_230V_manual/181363-Blue_Smart_Charger-pdf-pt.pdf">Manualul oficial Victron Blue Smart IP65 230 V</a> documentează etapele de încărcare și configurarea. Verifică întotdeauna manualul versiunii exacte cumpărate.</p>

  <h2>O ieșire sau două</h2>
  <p>O ieșire este suficientă dacă încarci doar bateria de servicii. O a doua ieșire poate menține bateria de pornire, dar nu înlocuiește separarea și protecțiile corecte. Verifică dacă ieșirile sunt independente și ce curent poate furniza fiecare.</p>

  <h2>Puterea încărcătorului și limita racordului</h2>
  <p>Un încărcător de 12 V și 30 A livrează aproximativ 430 W în etapa principală și cere mai mult la intrarea AC din cauza pierderilor. Adună frigiderul, încălzirea, fierbătorul și celelalte sarcini înainte să presupui că racordul campingului le poate alimenta simultan.</p>

  <h2>Partea de 230 V are nevoie de protecții dedicate</h2>
  <p>Intrarea de camping trebuie să aibă protecție diferențială și disjunctor dimensionate corect, împământare și cabluri potrivite. <a href="https://www.victronenergy.com/upload/documents/VE-Direct-drawing-with-IP43-Smart-Charger-12_50-1-Inverter-375W-2x125Ah-SC-AGM-MPPT-100_30-Argofet-Isolator-BMV-712.pdf">Schema oficială Victron cu încărcător IP43</a> arată protecția MCB/RCD pe intrarea AC și cere adaptarea cablurilor și siguranțelor la instalație.</p>
  <p><strong>230 V poate fi mortal.</strong> Dacă nu poți verifica împământarea, protecția diferențială, polaritatea, separarea AC/DC și normele locale, apelează la un electrician calificat.</p>

  <h2>Checklist înainte de cumpărare</h2>
  <ul>
    <li>12 V sau 24 V, identic cu banca de servicii;</li>
    <li>profil pentru LiFePO₄, AGM sau plumb;</li>
    <li>curent acceptat de baterie și BMS;</li>
    <li>timpul real la priză și consumurile simultane;</li>
    <li>blocare la temperatură joasă când este necesară;</li>
    <li>ventilație, zgomot, dimensiuni și protecția carcasei;</li>
    <li>cablu DC și siguranță lângă baterie conform manualului;</li>
    <li>RCD, disjunctor și împământare pe partea AC.</li>
  </ul>

  <h2>Leagă alegerea de întregul sistem</h2>
  <p>Folosește <a href="/ro/#calculator-preview">calculatorul pentru autorulotă</a> pentru baterie și consum zilnic, apoi verifică <a href="/ro/ghiduri/cabluri-sigurante-12v-autorulota/">ghidul de cabluri și siguranțe</a>. Curentul combinat din rețea, solar și alternator nu trebuie să depășească limita bateriei.</p>
</section>`,
    faq: Object.freeze([
      ["Ce amperaj trebuie să aibă încărcătorul de 230 V pentru 200 Ah LiFePO4?", "Depinde de limita bateriei și BMS și de timpul disponibil. Pentru 120 Ah de completat, 20 A înseamnă cel puțin 6 ore ideale, iar 30 A cel puțin 4 ore, înainte de pierderi și consumuri."],
      ["Pot folosi un încărcător AGM pentru LiFePO4?", "Numai dacă producătorul confirmă un profil LiFePO4 potrivit. Aceeași tensiune nominală de 12 V nu garantează compatibilitatea."],
      ["Este necesar un electrician pentru racordul de camping?", "Da, dacă nu poți verifica RCD-ul, disjunctorul, împământarea, cablurile și normele locale. La 230 V nu este sigur să lucrezi prin încercări."],
    ]),
  }),
